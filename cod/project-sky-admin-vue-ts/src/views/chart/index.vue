    ...
    <div class="container">
      <div class="chartBox">
        <div style="position: relative">
          ...
          <BarChart :chart-data="chartDataC" title="书籍分类占比" />
        </div>
        <div>
          <MixedChart :chart-data="chartDataB" title="书单销售排行" />
        </div>
      </div>
    </div>
    <div class="container">
